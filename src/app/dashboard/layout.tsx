        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          ...
          {user.role === 'ADMIN' && (
            <>
              ...
              <Link href="/dashboard/admin/tests/create" className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors">
